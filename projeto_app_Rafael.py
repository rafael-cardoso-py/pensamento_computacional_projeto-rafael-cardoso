...
# O inpunt serve para para pedir da tela
...
print('\nBem vindo ao Sistema de hamburgueria\n')
print('1. Cardapio')
print('2. delivery')
print('0. Sair')
...
print('\nEscolha uma opção\n')
    ...
    if escolha_menu == '1':
        ...
        selecione_os_acompanhantes = input("escolha até 2 acompanhamentos")




        # Exemplo Simples de Sistema de Delivery em Python
cardapio = {
    "1": {"nome": "Pizza", "preco": 30.00},
...
def realizar_pedido():
    ...
    while True:
        exibir_cardapio()
        escolha = input("Digite o número do item (ou 'sair' para finalizar): ")
...
#   educação na hora do atendimento, lanches rechados e bem saborosos,
# não demora pra ser servido, cardápio organizado para melhor desempenho,
